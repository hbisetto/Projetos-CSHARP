...
namespace ControleDeEstoque
{
    internal class Program
    {
        ...
        public static void Listar()
        {
            ...
            {
                Console.WriteLine("{0} . {1} ({2}) - {3} no estoque", livro1.posicao, livro1.titulo, livro1.preco, livro1.quantidade);
            }
            if (livro2.posicaobool == false)
            {
                Console.WriteLine("{0} . {1} ({2}) - {3} no estoque", livro2.posicao, livro2.titulo, livro2.preco, livro2.quantidade);
            }
            if (livro3.posicaobool == false)
            {
                Console.WriteLine("{0} . {1} ({2}) - {3} no estoque", livro3.posicao, livro3.titulo, livro3.preco, livro3.quantidade);
            }
        }
